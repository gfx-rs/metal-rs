use std::{mem::{size_of, transmute}, sync::Arc, ffi::c_void};
...
impl Scene {
    pub fn new(device: Device) -> Self {
        ...
        light_mesh.add_cube_with_faces(FACE_MASK_POSITIVE_Y, Vec3::new(1.0, 1.0, 1.0), transform, true);
        ...
        sphere_geometry.add_sphere_with_origin(Vec3::new(0.3275, 0.3, 0.3725), 0.3, Vec3::new(0.725, 0.71, 0.68));
        ...
        for y in -1..2 {
            for x in -1..2 {
                let transform = Mat4::from_translation(Vec3::new(x as f32 * 2.5, y as f32 * 2.5, 0.0));
                ...
                lights.push(AreaLight {
                    ...
                    colour: Vec4::new(rng.gen_range(0f32..=1.0), rng.gen_range(0f32..=1.0), rng.gen_range(0f32..=1.0), 0.0),
                });
            }
        }
        let lights_buffer =
